package de.suyuimo.teslamod.util.handlers;


import de.suyuimo.teslamod.TeslaMod;
import de.suyuimo.teslamod.init.BlockInit;
import de.suyuimo.teslamod.init.EnchantmentInit;
...
public class RegistryHandler
{
    ...
    {
        NetworkRegistry.INSTANCE.registerGuiHandler(TeslaMod.instance, new GuiHandler());
